...
public class PaymentUtil {
    ...
    static {
        ...
        Payment p1 = new Payment("1-12", 1, new DateTime(calendar1), 166d);
        Payment p2 = new Payment("4-132", 2, new DateTime(calendar2), 500d);
        Payment p3 = new Payment("1-16", 1, new DateTime(calendar3), 1000.5d);

        calendar1.add(Calendar.SECOND, 2);
        calendar2.add(Calendar.SECOND, 2);
        calendar3.add(Calendar.SECOND, 2);
        p1.setRegistrationTime(new DateTime(calendar1));
        p2.setRegistrationTime(new DateTime(calendar2));
        p3.setRegistrationTime(new DateTime(calendar3));
